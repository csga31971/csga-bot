...
// d为主函数，其中函数b为AES加密，函数c为RSA加密
// 以下参数都是固定字符串
// e = 010001
// f = 
// g = 0CoJUm6Qyw8W8jud
// https://www.jianshu.com/p/2146469bb29c
function d(d, e, f, g) {
    var h = {},
        i = a(16);
...
// d函数 = 生成一对RSA加密key，由于参数都是固定的，key也是固定的
// e函数 = RSA加密
function c(a, b, c) {
    var d, e;
...
//把16进制数从后四位开始每四位转换成十进制，存到BigInt里，后四位存degits[0]里以此类推
...
//BigInt最高位数，也就是a.digits数组里最后一个不为0的值的下标
...
function encryptedString(a, b) {
    for (var f, g, h, i, j, k, l, c = new Array, d = b.length, e = 0; d > e;) c[e] = b.charCodeAt(e), e++;// c=b.toCharArray
    for (; 0 != c.length % a.chunkSize;) c[e++] = 0; // 后面补0，由于a是固定的，这里a.chunkSize=256
